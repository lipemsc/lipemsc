...
Utilizador de Linux - já usei tudo desde Ubuntu, Debian, Fedora, Arch (btw) e derivados dessas distros :revolving_hearts: :penguin:
...
Linux user - used everything from Ubuntu, Debian, Fedora, Arch (btw) and derivatives :revolving_hearts: :penguin:
